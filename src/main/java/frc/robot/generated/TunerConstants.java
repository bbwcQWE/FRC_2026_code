...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(.01).withKI(0).withKD(0).withKS(0.2234).withKV(0.79659);
  ...
  public static final CANBus kCANBus = new CANBus("CANNORE", "./logs/example.hoot");
  ...
  private static final Distance kWheelRadius = Inches.of(1.879);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.298828125);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.123779296875);
